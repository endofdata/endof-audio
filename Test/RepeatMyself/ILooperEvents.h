...
namespace Audio
{
	namespace Foundation
	{
		namespace Unmanaged
		{
			...
			{
				__interface _AUDIO_FOUNDATION_UNMANAGED_API  ILooper;

				__interface _AUDIO_FOUNDATION_UNMANAGED_API  _declspec(uuid("98bd51b8-8ab7-4a58-825b-70f77c447675")) ILooperEvents : public IUnknown
				{
				...
				_AUDIO_FOUNDATION_UNMANAGED_API  _COM_SMARTPTR_TYPEDEF(ILooperEvents, __uuidof(ILooperEvents));
			}
		}
	}
}